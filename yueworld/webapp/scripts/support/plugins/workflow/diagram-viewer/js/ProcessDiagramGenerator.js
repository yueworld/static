...
var ProcessDiagramGenerator = {
    ...
    setHighLights: function (highLights) {
        console.log(highLights.processDefinitionId)
    ...
    drawDiagram: function (processId, instanceId) {
        // Hide all diagrams
        ...
        /*if (processId.indexOf(":") < 0) {
         ActivitiRest.getProcessDefinitionByKey(processId, this._drawDiagram);
         } else {
         this._drawDiagram.apply({processDefinitionId: processId});
         }*/
        this._drawDiagram.apply({processDefinitionId: processId, instanceId: instanceId});
    },
