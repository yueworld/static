...
// var DefaultProcessDiagramCanvas = {
    ...
    init: function (width, height, processDefinitionId) {
        ...
        h.style.width = width;
        if (getParams("width")) {
            var proportion = (getParams("width") / width)
            this.g = Raphael(this.canvasHolder, getParams("width") || width, height * proportion);
            h.style.height = height * proportion;
            if (parent.$app) {
                parent.$app.publish("/workflow/diagram-viewer/load", {
                    width: getParams("width") || width,
        ...
        this.g.setViewBox(0, 0, width, height)
