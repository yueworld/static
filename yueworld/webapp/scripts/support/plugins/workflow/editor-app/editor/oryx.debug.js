...
ORYX = Object.extend(ORYX, {
    ...
    //set the path in the defaults.js file!!!!
     ...
     * yet loaded, defaults.js is being requested from the server. A repeated
...
ORYX.Core.StencilSet.Stencil = {
    ...
    postProcessProperties: function () {
        ...
        if (this._jsonStencil.propertyPackages && this._jsonStencil.propertyPackages instanceof Array) {
            ...
            this._jsonStencil.hiddenPropertyPackages.each((function (ppId) {
                var index = this._jsonStencil.propertyPackages.indexOf(ppId);
                if (-1 != index) {
                    // this._jsonStencil.propertyPackages.splice(index, 1);
                }
            }).bind(this));
