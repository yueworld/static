...
(function ($app) {
    $app.config(["$urlRouterProvider", function ($urlRouterProvider) {
        ...
        $urlRouterProvider.otherwise(function () {
            if ($app.user.login) {
                return "/basic/info/project/index.html";
            }
        })
    }]);
    // 基础数据
...
})(window.$app = require("yueworld")(angular.module("$app", ["ngLocale", "ngAnimate", "ngSanitize", "pasvaz.bindonce", "ui.bootstrap", "ui.router"])));